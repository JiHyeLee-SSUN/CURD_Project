        ...
        <div class="jumbotron" align="center">
            ...
            <div>
                ...
                <span style="font-size: 1em; letter-spacing: 2px; word-spacing: 4px">
						...
						설계한 코드에 따라 결과가 달라지고 무한한 가능성을 보여주는 점에서 매력을 느꼈고, 각종언어로 프로그래밍 과제와 팀프로젝트를 한 경험이 지금의 제 진로에 많은 영향을 주었다고 생각합니다.<br><br>
						신입인 만큼 기본기에 충실해야 된다 생각해 JAVA와 자료구조 공부에 힘쓰고 있습니다. 단순히 기술적인 부분만 공부하는 것에 그치지 않고,
						제 실력을 기록하며 작은 지식이나마 나누는 것 또한 가치가 있다고 생각하여 블로그 활동도 하고 있습니다.
					</span>
            </div>
            <br>
            <div>
                <a href="https://2-jissun.tistory.com/"><img width="13%" class="img-logo" src="<c:url value="/resources/img/tistory.png" />" alt="티스토리링크"></a>
                <a href="https://github.com/JiHyeLee-SSUN/CURD_Project"><img width="10%" class="img-logo" src="<c:url value="/resources/img/github-logo.png" />" alt="깃허브링크"></a>
            </div>
        </div>
    </div>
    <div class="jumbotron">
